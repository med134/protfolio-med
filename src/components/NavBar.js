...
const NavBar = () => {
  ...
  return (
    ...
    >
      ...
      <div className="w-full flex justify-between items-center font-semibold lg:hidden">
        ...
        <nav className="flex items-center justify-center flex-wrap">
          ...
          <motion.a
            href="https://wa.me/+212600462196"
            target={"_blank"}
            className="w-6 mx-3"
            whileHover={{ y: -2 }}
            whileTap={{ scale: 0.9 }}
          >
            <BsWhatsapp size={24} className="fill-emerald-500" />
          </motion.a>
          <motion.a
          ...
          <button
            ...
            className={`w-8 h-8 ml-3 flex items-center justify-center rounded-full p-1 ease
        ...
        >
          ...
          <nav className="flex items-center justify-center flex-wrap mt-2">
            ...
            <motion.a
              href="https://wa.me/+212600462196"
              target={"_blank"}
              className="w-6 mx-4 px-2 sm:mx-1"
              whileHover={{ y: -2 }}
              whileTap={{ scale: 0.9 }}
            >
              <BsWhatsapp size={24} className="fill-emerald-500" />
            ...
            <button
              onClick={() => setMode(mode === "light" ? "dark" : "light")}
              className={`w-8 h-8 ml-3 flex items-center justify-center rounded-full p-1
      ${mode === "light" ? "bg-dark text-light" : "bg-light text-dark"}
      `}
            >
              {mode === "light" ? (
